...
**AI O&M Copilot for Utility-Scale Solar**
...
| **Role**                      | **Primary responsibility**                                                | **System objective**                                                                         |
| ----------------------------- | ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Head of O&M                   | Runs plant reliability, issue triage, and dispatch priorities.            | View urgent findings, understand what must be fixed first, and reduce downtime.              |
| Asset Manager                 | Owns plant performance and financial outcomes.                            | See estimated energy / revenue impact, recurring issues, and evidence-backed actions.        |
| Inspection Lead               | Manages drone or inspection data collection and batch completeness.       | Upload inspection batches quickly and confirm that files are mapped and processed correctly. |
| Operations Analyst / Reviewer | Reviews AI-generated findings and recommendations.                        | Accept, edit, or reject system suggestions and retain review comments for traceability.      |
| Executive Sponsor             | Wants quick proof of business value and pilot readiness.                  | See a simple summary of site health, critical issues, and likely operational value.          |
| System Administrator          | Maintains thresholds, site mappings, model versions, and prompt versions. | Configure the platform, manage controls, and maintain operational traceability.              |

## 3.2 AI roles in the platform (layman examples)

| **AI role**             | **What the AI does**                                                                                                                  | **Layman example**                                                                                                            |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| Visual Detection AI     | Looks at thermal and RGB inspection images to detect likely issues such as hotspots, heavy soiling, visible damage, or row anomalies. | Like a junior inspector scanning hundreds of photos and pointing out which pictures deserve attention first.                  |
| Evidence Correlation AI | Joins visual findings with alarms, weather, maintenance history, and site layout to build a fuller picture of what may be happening.  | Like a supervisor who does not look at the photo alone, but also checks machine alarms and past repair notes before deciding. |
| Prioritization AI       | Ranks issues by severity, confidence, recurrence, and likely impact so teams know what to handle first.                               | Like a hospital triage nurse deciding which patient must be seen immediately and which case can wait.                         |
| Recommendation AI       | Suggests the next action such as inspect now, clean within 48 hours, dispatch technician, monitor next cycle, or no action.           | Like an experienced maintenance planner turning observations into an actual next step.                                        |
| Explainability AI       | Writes a plain-language explanation of why the system raised an issue and why it recommended a certain action.                        | Like a senior engineer explaining, in simple words, why a problem looks urgent and what evidence supports that view.          |
| Historical Memory AI    | Checks whether the same zone, row, or string had a similar problem before and raises recurrence awareness.                            | Like a team member who remembers that this exact area already had trouble last month and warns that it may be repeating.      |
| Reporting AI            | Creates a summary report for operations, management, or pilot review using the latest approved findings.                              | Like an analyst who converts many inspection notes into a clean management summary.                                           |
| Human-in-the-Loop AI    | Supports the reviewer with suggestions but does not make final operational decisions on its own.                                      | Like a smart assistant that drafts the recommendation, but a human manager still signs off before action is taken.            |
...
| **ID** | **Requirement area**         | **Requirement statement**                                                                                                                                                                   |
| ------ | ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **ID** | **AI requirement area**          | **Requirement statement**                                                                                                                                         |
| ------ | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
